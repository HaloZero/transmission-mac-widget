...
enum Constants {
    ...
    /// How often the widget asks WidgetKit to check back for a new timeline
    /// entry — a free ask, since a cache hit costs nothing; WidgetKit's own
    /// budget/visibility throttling decides the real-world cadence.
